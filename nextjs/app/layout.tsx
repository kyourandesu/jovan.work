...
export const metadata: Metadata = {
  ...
  description:
    "Jovan Tan is a developer turning complex AI and data into products people actually use — from reinforcement-learning agents to an EdTech platform serving 2,000+ users.",
